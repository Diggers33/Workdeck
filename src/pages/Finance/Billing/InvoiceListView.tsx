...
import { FileText, Circle, Clock, CheckCircle2, XCircle, Plus, ChevronDown } from 'lucide-react';
...
export function InvoiceListView({ invoices, onViewInvoice, onEditInvoice, onCreateNew }: InvoiceListViewProps) {
  const { markInvoiceAsPaid } = useBilling();
  ...
  const sortedInvoices = useMemo(() => {
    return [...filteredInvoices].sort((a, b) => {
      ...
      const statusPriority: Record<string, number> = { draft: 0, pending: 1, paid: 2, cancelled: 3 };
