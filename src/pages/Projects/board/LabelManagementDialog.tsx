...
export function LabelManagementDialog({ onClose, currentLabels, onSaveLabels }: LabelManagementDialogProps) {
  ...
  // Mock boards for copying labels from
  const availableBoards = [
    { id: 'board-1', name: 'Marketing Campaign', projectName: 'BIOGEMSE' },
    { id: 'board-2', name: 'Product Development', projectName: 'GENCORE' },
    { id: 'board-3', name: 'Infrastructure', projectName: 'TECHOPS' },
    { id: 'board-4', name: 'Design System', projectName: 'UIKIT' }
  ];

  const boardLabelSets: Record<string, Label[]> = {
    'board-1': [
      { id: 'ml1', name: 'Social Media', color: '#968fe5' },
      { id: 'ml2', name: 'Content', color: '#00b4cd' },
      { id: 'ml3', name: 'Analytics', color: '#ffbd01' },
      { id: 'ml4', name: 'Campaign', color: '#F87171' }
    ],
    'board-2': [
      { id: 'pd1', name: 'Feature', color: '#34D399' },
      { id: 'pd2', name: 'Bug', color: '#F87171' },
      { id: 'pd3', name: 'Enhancement', color: '#60A5FA' },
      { id: 'pd4', name: 'Technical Debt', color: '#9CA3AF' }
    ],
    'board-3': [
      { id: 'inf1', name: 'DevOps', color: '#ffbd01' },
      { id: 'inf2', name: 'Security', color: '#F87171' },
      { id: 'inf3', name: 'Monitoring', color: '#968fe5' },
      { id: 'inf4', name: 'Infrastructure', color: '#34D399' }
    ],
    'board-4': [
      { id: 'ds1', name: 'Component', color: '#60A5FA' },
      { id: 'ds2', name: 'Documentation', color: '#00b4cd' },
      { id: 'ds3', name: 'Accessibility', color: '#34D399' },
      { id: 'ds4', name: 'Design Token', color: '#968fe5' }
    ]
  };
