...
export function TaskDetailModal({ task, onClose, onUpdateTask }: TaskDetailModalProps) {
  ...
  const tabs = [
    ...
    { id: 'participants', label: 'Participants', icon: <Users size={18} />, badge: 8 },
    { id: 'comments', label: 'Comments', icon: <MessageSquare size={18} />, badge: 3 },
    { id: 'files', label: 'Files', icon: <Paperclip size={18} />, badge: 5 },
