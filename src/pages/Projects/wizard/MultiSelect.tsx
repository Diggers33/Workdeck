  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="w-full min-h-[40px] px-3 py-2 text-left bg-white border border-slate-200 rounded-md hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
      >
        ...
        <div className="absolute z-50 w-full mt-1 bg-white border border-slate-200 rounded-md shadow-lg max-h-60 overflow-auto">
          {options.map((option) => {
            ...
            return (
              ...
              >
                <span className={isSelected ? 'text-blue-600' : 'text-slate-900'}>{option.label}</span>
