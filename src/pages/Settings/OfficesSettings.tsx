  ...
  const [offices, setOffices] = useState([
    {
      id: 1,
      name: 'London HQ',
      address: '123 Design Street, London SW1A 1AA, UK',
      currency: 'GBP',
      ...
      region: 'England',
      regionalCalendar: getRegionalCalendar('United Kingdom', 'England'),
      companyClosures: [] as CompanyClosure[],
      holidayExceptions: [] as HolidayException[]
    },
    {
      id: 2,
      name: 'New York Office',
      address: '456 Creative Ave, New York, NY 10001, USA',
      currency: 'USD',
      ...
      region: 'Federal',
      regionalCalendar: getRegionalCalendar('United States', 'Federal'),
      companyClosures: [] as CompanyClosure[],
      holidayExceptions: [] as HolidayException[]
    }
  ]);
              ...
              <div key={office.id} className="bg-white rounded-lg border border-[#E5E7EB] p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button className="p-2 hover:bg-[#F3F4F6] rounded-lg transition-colors" title="Edit">
                      <Edit2 className="w-4 h-4 text-[#6B7280]" />
                    </button>
                    <button className="p-2 hover:bg-[#FEE2E2] rounded-lg transition-colors" title="Delete">
