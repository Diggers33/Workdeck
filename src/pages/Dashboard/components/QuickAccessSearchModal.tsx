  ...
  const [items, setItems] = useState<QuickAccessItem[]>([
    {
      ...
      subtitle: 'Project • On Track',
      category: 'project',
      isPinned: true,
      lastAccessed: new Date(Date.now() - 1000 * 60 * 30),
      accessCount: 145,
      path: '/work/projects/phoenix-rebrand'
    },
    {
      id: '2',
      ...
      accessCount: 89,
      path: '/work/resource-planner'
    },
    {
      id: '3',
      title: 'Website wireframes',
      subtitle: 'Task • Apex Digital',
      category: 'task',
      isPinned: false,
      lastAccessed: new Date(Date.now() - 1000 * 60 * 15),
      accessCount: 23,
      path: '/work/tasks/website-wireframes'
    },
    {
      id: '4',
      title: 'Project Triage Board',
      subtitle: 'View',
      category: 'view',
      isPinned: false,
    ...
    {
      id: '6',
      title: 'Apex Digital Redesign',
      subtitle: 'Project • At Risk',
      category: 'project',
      isPinned: false,
      lastAccessed: new Date(Date.now() - 1000 * 60 * 60 * 8),
      accessCount: 78,
      path: '/work/projects/apex-digital'
    }
  ]);
