...
export function PendingApprovalsWidget() {
  const approvals = [
    { id: 1, title: 'Budget increase for BIOGEMSE', requestor: 'Charlie Day', amount: '€12,500', urgent: true },
    { id: 2, title: 'Time off request', requestor: 'Alice Chen', amount: 'Dec 23-27', urgent: false },
    { id: 3, title: 'Equipment purchase', requestor: 'Bob Ross', amount: '€8,200', urgent: false },
    { id: 4, title: 'Contractor approval', requestor: 'Emma Wilson', amount: '€5,400/mo', urgent: true }
  ];
              ...
              <div className="flex items-start justify-between mb-1.5">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-[#9CA3AF] mt-0.5">
                    {approval.requestor} • {approval.amount}
                  </p>
                </div>
                {approval.urgent && (
